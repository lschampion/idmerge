...
public class PropertyUtil {
	...
	public final static Properties getProperties(String propertyFilePath) {
		if (propertyFilePath == null) {
			System.out.println("propertyFilePath is null!");
			return null;
		}
	...
	private static Properties loadPropertyFileByFileSystem(
		...
		try {
			...
			System.out.println("FileInputStream(\"" + propertyFilePath
					+ "\")! FileNotFoundException: " + e);
			return null;
		} catch (IOException e) {
			System.out.println("Properties.load(InputStream)! IOException: " + e);
			return null;
		}
	}
	...
	public final static boolean setValueAndStore(String propertyFilePath,
		...
		try {
			...
			String path = PropertyUtil.class.getResource(propertyFilePath)
					.getPath();
			System.out.println("~~~~~~~~path~~~XXX~~~~~" + path);
			try {
				stream = new java.io.FileOutputStream(path);
			} catch (FileNotFoundException e1) {
				System.out.println("FileNotFoundException! path=" + propertyFilePath);
				return false;
			}
		}
	...
	public final static void store(Properties properties,
		...
		try {
			...
			System.out.println("FileOutputStream(" + propertyFilePath
					+ ")! FileNotFoundException: " + e);
			...
			System.out.println("store(stream, msg)! IOException: " + e);
			e.printStackTrace();
		}
	}
	...
	public final static boolean updateValue(String propertyFilePath,
		...
		if (key == null || newValue == null) {
			System.out.println("key or newValue is null!");
			return false;
		}
	...
	public static void main(String[] args) {
	    String path=args[0];
	    String key=args[1];
	    String v = PropertyUtil.getValue(path, key);
	    System.out.println(v);
	    
//		String path = "D:\\workspaces\\eclipse\\dsbox\\resources\\paramsGdpi.properties";
//
//		String v = PropertyUtil.getValue(path, "mergepid.input.hdfs.path.gdpi");
//		System.out.println(v);
//		//
//		// _log.info("value0 = " + v);
//		// System.out.println("/com/vodone/search/config/test.properties");
//		//
//		Hashtable<String, String> ht = new Hashtable<String, String>();
